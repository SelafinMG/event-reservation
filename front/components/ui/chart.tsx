...
import { TooltipProps, TooltipPayload, LegendProps, LegendPayload } from 'recharts'
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    if (hideLabel || !(payload as TooltipPayload[])?.length) {
      return null
    }
  ...
  if (!active || !(payload as TooltipPayload[])?.length) {
    return null
  }
...
function ChartLegendContent({
  ...
  if (!(payload as LegendPayload[])?.length) {
    return null
  }
